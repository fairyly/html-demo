    provinceArray = new Array("不限","北京","上海","天津","重庆","河北","山西","内蒙古自治区","辽宁","吉林","黑龙江","江苏","浙江","安徽","福建","江西","山东","河南","湖北","湖南","广东","广西壮族自治区","海南","四川","贵州","云南","西藏自治区","陕西","甘肃","宁夏回族自治区","青海","新疆维吾尔族自治区","香港特别行政区","澳门特别行政区","台湾","其它");  
    ...
    {  
        ...
        for (i = 0 ;i <cityArray.length;i++)  
		  ...
		  $("#selProvince").change(function(){
		       $("#address_1 span").eq(0).html($(this).val());
			   $("#address_1 span").eq(1).html(tmpcityArray[0]);
			   $('#yprov').val($(this).val());
			   
		  })
		  $("#selCity").change(function(){
		    $("#address_1 span").eq(1).html($(this).val());
			$('#ycity').val($(this).val());
		  })
          $("#max").change(function(){
		    $("#address_2 span").eq(0).html($(this).val())
		  })	  
    } 
