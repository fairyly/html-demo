$(function()
{
    ...
    */
    ...
    $('#date-range0').dateRangePicker(
    {
        language:'cn',
        singleMonth: true,
        beforeShowDay: function(t) { //自定义哪些日期不可选
            var valid = !(t > new Date());
            var _class = '';
            var _tooltip = valid ? '' : '当日之后不可选'; //自定义弹窗提示
    ...
    .bind('datepicker-change',function(event,obj)
    {
        ...
        // }
        $('.daterange span').html(obj.value)
        $('#date-range0').val(obj.value)
    })
    ...
    .bind('datepicker-close',function(e,obj)
    {
        /* This event will be triggered before date range picker close animation */
        console.log('before close',obj['value']);
         /*$('.daterange span').html(obj.value)
        $('#date-range0').val(obj.value)*/
    })
    ...
    //         var valid = !(t > new Date());  //disable saturday and sunday
    //         var _class = '';
