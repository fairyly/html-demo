...
(function(factory) {
    ...
    $.fn.dateRangePicker = function(opt) {
        ...
        function IsOwnDatePickerClicked(evt, selfObj) {
            console.log(evt,selfObj)//selfObj.contains(evt.target) || 
        ...
        function updateCalendarWidth() {
            ...
            box.find('.month-wrapper').width('100%');
        }
        ...
        function showSelectedInfo(forceValid, silent) {
            ...
            if (opt.start) {
                box.find('.start-day').html(formatTime(new Date(parseInt(opt.start))));
            }
            if (opt.end) {
                box.find('.end-day').html(formatTime(new Date(parseInt(opt.end))));
            }
            var dateRange;
        ...
        function createDom() {
            ...
            html += '<div class="month-wrapper">' +
                ...
                '           <tr class="caption">' +
                '               <th style="width:27px;">' +
                '                   <span class="prev iconfont icon-back">' +
                // arrowPrev +
                '                   </span>' +
                '               </th>' +
                '               <th colspan="' + _colspan + '" class="month-name">' +
                '               </th>' +
                '               <th style="width:27px;">' +//'// + arrowNext + '
                (opt.singleDate || !opt.stickyMonths ? '<span class="next iconfont icon-arrow_right"></span>' : '') +
                '               </th>' +
                '           </tr>' +
            ...
            if (opt.showTopbar) {
                ...
                if (opt.customTopBar) {
                    ...
                    html += '<div class="normal-top">' +
                        '<span class="data-span data-left-start">开始时间:<b class="start-day"></b></span>';//<span style="color:#333">' + translate('selected') + ' </span> 
                    if (!opt.singleDate) {
                        // html += ' <span class="separator-day">' + opt.separator + '</span> <b class="end-day">...</b> <i class="selected-days">(<span class="selected-days-num">3</span> ' + translate('days') + ')</i>';
                        html += '<span class="data-span data-left-end">结束时间:<b class="end-day"></b></span>'
                    }
                    html += '</div>';
        ...
        function getWeekHead() {
            ...
            if (opt.startOfWeek == 'monday') {
                ...
                return prepend + '<th style="color:#f30303;">' + translate('week-7') + '</th>' +
                    '<th>' + translate('week-1') + '</th>' +
                    '<th>' + translate('week-2') + '</th>' +
                    '<th>' + translate('week-3') + '</th>' +
                    '<th>' + translate('week-4') + '</th>' +
                    '<th>' + translate('week-5') + '</th>' +
                    '<th style="color:#f30303;">' + translate('week-6') + '</th>';
            }
        }
