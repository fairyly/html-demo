...
<html>
  <head>
    ...
    <meta name="chromesniffer" id="chromesniffer_meta" content="{&quot;Java&quot;:-1}">
    ...
    <body class="body--ready" data-pinterest-extension-installed="cr1.39.1">
        ...
        <p class="text">
            <a href="http://blog.exrick.cn" target="_blank">blog.exrick.cn</a>
        </p>
        <script>
            var S = {
                init: function () {
                    ...
                    S.UI.simulate("I AM|小黄鱼|四川 成都|95后|天蝎座|软件设计师|#time");
